        ...
        <table class="table-body">
            ...
            <c:forEach items = "${queryInfoStateList }" var = "info">
	            ...
	            <tr>
	                ...
	                <td>
	                	<c:if test="${info.getInfo_pay_state()==1}">
	                		<div class="div-yes">是</div>
	                	</c:if>
	                	<c:if test="${info.getInfo_pay_state()==0 }">
	                		<div class="div-no">否</div>
	                	</c:if>
	                </td>
	                <td>
	                	<c:if test="${info.getInfo_check_state()==1}">
	                		<div class="div-yes">是</div>
	                	</c:if>
	                	<c:if test="${info.getInfo_check_state()==0 }">
	                		<div class="div-no">否</div>
	                	</c:if>
	                </td>
	                <td>
